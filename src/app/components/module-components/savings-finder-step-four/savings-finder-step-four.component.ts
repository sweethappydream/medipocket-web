...
export class SavingsFinderStepFourComponent implements OnInit {
  ...
  totalvalue = 0;
  constructor(private modalService: NgbModal, private http: HttpClient, private spinnerService: Ng4LoadingSpinnerService, private router: Router) {
  ...
  gosavingCard() {
    ...
    this.router.navigate(['/app/pharmacy-savings-card']);
  }
