...
declare var $: any;
@Component({
  selector: 'app-pharmacy-savings-card-for-pets',
  templateUrl: './pharmacy-savings-card-for-pets.component.html',
  styleUrls: ['./pharmacy-savings-card-for-pets.component.scss']
})
export class PharmacySavingsCardForPetsComponent implements OnInit {
